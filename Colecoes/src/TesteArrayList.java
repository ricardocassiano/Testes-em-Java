/*
 * Consultar o artigo https://www.devmedia.com.br/explorando-a-classe-arraylist-no-java/24298
 * 
 */
...
public class TesteArrayList {
  ...
  public static void main(String[] args) {
    ...
    //O tipo da lista é definido dentro dos <>, pode ser qualquer um.
    ...
    //Através do console é feita a solicitação de uma posição a ser excluída.
    System.out.printf("\nInforme a posição a ser excluída:\n");
    i = ler.nextInt();//objeto usado apenas para leitura de um caracter
 
    //Tratamento da exceção (Caso o usuário digite um índice inválido)
    try {
    ...
    //Declaração de um objeto da classe Iterator
    Iterator<String> iterator = agenda.iterator();
    //Enquanto o método hasNext() retornar true
